...
export const Footer = () => {
  return (
    <footer className="w-full text-center text-sm text-gray-500 py-6 z-10 flex flex-col gap-2 relative bg-black">
      <span>&copy; {new Date().getFullYear()} Ben Rutledge </span>
